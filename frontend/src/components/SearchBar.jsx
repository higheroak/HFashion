  ...
  return (
    <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-sm" data-testid="search-overlay">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <form onSubmit={handleSearchSubmit} className="relative">
          <div className="relative flex items-center">
            ...
            <Input
              ...
              className="h-14 pl-12 pr-24 text-lg rounded-full border-2 focus:border-primary"
        ...
        {/* Search Results */}
        {showResults && (
          <div className="mt-6 bg-card rounded-xl border shadow-lg overflow-hidden" data-testid="search-results">
            {results.length === 0 ? (
